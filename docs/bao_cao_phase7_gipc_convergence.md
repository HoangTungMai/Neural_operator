...
This convergence report belongs to the pre-corrected-BC `REALISTIC.npz` lineage.
It is kept only as provenance. The current KSE submission source of truth is
