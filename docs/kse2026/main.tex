...
runs $24.1\times$ faster, and reaches lower final loss than a gradient-free
...
$24.1\times$ less wall-clock than evolution strategies, while also reaching lower final loss
...
$0.067$ and the Galerkin Transformer at $0.091$. The defensible message is
...
The operator runs at $\sim$$7803$ frames/s ($\sim$$0.13$\,ms latency) versus
$0.094$\,frames/s for a fair single IPC/GIPC solve---a
$\sim$$82{,}827\times$ speedup over IPC (Fig.~\ref{fig:fidspeed}). The production
...
the averaged $K{=}3$ production target.}
\label{fig:fidspeed}
\end{figure}
...
$\mathbf{317.75}$\,s ($24.1\times$ faster). It first reaches the target after
...
ES (pop 32) & $6.21\times10^{-10}$ & 19{,}200 & 317.75 \\
\midrule
...
current noisy image-reward environment has $5.21\%$ relative error and is therefore
