...
def build() -> Path:
    ...
    table(
        ...
        [
            [
                "src/novbts/simulation/sensor/markercam.py",
    ...
    bullet(pdf, "Regenerate: python -m novbts.simulation.sensor.build_sensor_dataset && python -m novbts.simulation.sensor.sensor_inverse_demo")
