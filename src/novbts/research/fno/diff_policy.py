...
Task A (antislip, probe-gated): policy pi(mu,R,E,disturbance) -> depth; loss reads
  ...
  python -m novbts.research.fno.diff_policy --probe
  python -m novbts.research.fno.diff_policy --train-policy --task servo --n-seeds 3
"""
import argparse
import json
import os
...
from novbts.research.groundtruth.hertz_mindlin import hertz_mindlin_field, hertz_scalars
