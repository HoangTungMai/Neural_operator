...
from novbts.research.models import CoordinateMLP
from novbts.research.fno.param2field import (
...
def main():
    ...
    from novbts.research.groundtruth.hertz_mindlin import hertz_mindlin_field
