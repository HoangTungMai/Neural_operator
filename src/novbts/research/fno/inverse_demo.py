...
hours where autograd is < 1 s.
  ...
  python -m novbts.research.fno.inverse_demo --data data/fem/shear_fine_swept_normaug.npz
"""
import argparse
import json
import time
...
from novbts.research.groundtruth.hertz_mindlin import hertz_scalars, MODE_NAMES
