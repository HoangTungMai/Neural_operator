...
(2) Differentiable inverse FROM THE SENSOR IMAGE: recover the applied shear (sx,sy)
  ...
  python -m novbts.simulation.sensor.sensor_inverse_demo \
...
from novbts.research.fno.field2field import FNOField, train_operator, count_parameters, DEV
from novbts.research.fno.fem_benchmark import load, norm_from
from novbts.research.fno.inverse_demo import build_input_channels
from novbts.research.groundtruth.hertz_mindlin import MODE_NAMES
