...
a preview montage.
  ...
  python -m novbts.simulation.sensor.build_sensor_dataset --data data/uipc/shear_res24_avg_swept_REALISTIC_BC.npz
"""
import argparse
import json
import os
...
from novbts.research.fno.field2field import DEV
