...
rest frame (minimising marker-position residual) -- a thin optimisation left as a stub here.
  ...
  python -m novbts.simulation.sensor.calibration --template            # write a blank physical-build config
  python -m novbts.simulation.sensor.calibration --from-sim            # snapshot the current sim sensor
"""
import argparse
import json
